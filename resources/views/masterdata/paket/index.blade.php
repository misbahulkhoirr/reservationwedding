...
<div class="container" style="margin-top: 100px">
      ...
      <div class="row mb-3 mt-3">
        <div class="d-flex justify-content-end">
          ...
          <a href="{{url('paket/create')}}" class="btn btn-info text-white">+ Tambah Data</a>
          @endif
        </div>
    </div>
    ...
    <div class="row text-center">
      @foreach($pakets as $row)
        <div class="col-md-4">
          <a href="paket/{{$row->id}}" style="text-decoration: none; color:rgb(29, 28, 28)">
            <div class="card">
              @if ($row->gambar)
                ...
                <div class="card-body">
                  ...
                  <div class="row mt-3">
                    <div class="col-md-6">
                      ...
                      <a href="paket/{{$row->id}}/edit" class="btn btn-sm btn-info text-white d-block"><i class="fa-solid fa-pen-to-square"></i></a>
                    </div>
                    <div class="col-md-6">
